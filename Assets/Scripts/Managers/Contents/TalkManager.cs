...
public class TalkManager
{
    ...
    void GeneratedData()
    {
		talkData.Add(10 + 1000, new string[] { "아니, 이런 위험한 곳에는 무슨 일이신가요? \n아... 달의 소문을 듣고 오신 모험가님이시군요.",
			...
			"이 앞은 위험합니다. 그러니 그 전에 모험가님을 시험해 봐도 괜찮을까요?\n 오른쪽으로 가면 슬라임들이 있어요. 슬라임 다섯 마리만 처리해 주시겠어요?" });

		talkData.Add(10 + 1001, new string[] { "슬라임 다섯 마리를 잡아 주세요. 오른쪽으로 이동하시면 돼요." });
		talkData.Add(1000, new string[] { "정말 강하시군요! 동굴은 북쪽의 숲에 있습니다.\n용감한 모험가님께 달의 가호가 함께하기를." });

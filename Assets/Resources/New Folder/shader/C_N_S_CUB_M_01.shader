...
_CUBE_P("_CUBE_P", Range(0,1) ) = 0.5
_cube_M("_cube_M", Cube) = "black" {}
_CUBE_Color("_CUBE_Color", Color) = (0,0,0,1)
...
float4 TexCUBE0=texCUBE(_cube_M,float4( IN.sWorldNormal.x, IN.sWorldNormal.y,IN.sWorldNormal.z,1.0 ));
float4 Add0=_CUBE_Color + TexCUBE0;
float4 Multiply0=Add0 * _CUBE_P.xxxx;
